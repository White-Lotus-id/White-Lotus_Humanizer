...
note: this is optimized for claude only(sonnet 5 below, with medium effort only for sonnet 5 as it gets flagged by the anthropic regulations when use maximum effort)
## Disclaimer
